            ...
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                  ...
                  <?php elseif($orderInfo['pay_type'] == 2): ?>
                    您选定的支付方式为: <font color="#ff4e00">转账</font>；
                  <?php else: ?>
              ...
              <tr>
                <td style="padding:20px 0 30px 0; font-family:'宋体';">
                	银行名称 收款人信息：全称 杜** ；帐号或地址 4521234563121373 ；开户行 中国银行。 <br />
              ...
              <tr>
                <td>
                    <div class="btn_u" style="margin:0 auto; padding:0 20px; width:120px;">
                      <a href="<?php echo url('order/alipay'); ?>?order_number=<?php echo $orderInfo['order_number']; ?>">立即使用支付宝支付</a>
                    </div>
