...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="__ROOT__/goods_img/<?php echo $goodsInfo['goods_img']; ?>" title="Images" class="MagicZoom" id="MagicZoom"><img src="__ROOT__/goods_img/<?php echo $goodsInfo['goods_img']; ?>" width="390" height="390" /></a></div>
            <div id="tsPicContainer">
                <div id="tsImgSArrL" onclick="tsScrollArrLeft()"></div>
                <div id="tsImgSCon" style="width:600px">
                    <ul style="width:500px">
                        <?php if(is_array($goodsInfo['goods_imgs']) || $goodsInfo['goods_imgs'] instanceof \think\Collection || $goodsInfo['goods_imgs'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsInfo['goods_imgs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <li onclick="showPic(<?php echo $key; ?>)" rel="MagicZoom" >
                                <img src="__ROOT__/goods_imgs/<?php echo $v; ?>" tsImgS="__ROOT__/goods_imgs/<?php echo $v; ?>"/>
                            </li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
        ...
        <div class="pro_des">
            ...
            <div class="des_price">
            	本店价格：<b>￥<?php echo $goodsInfo['self_price']; ?> </b><br />
                消费积分：<span><?php echo $goodsInfo['goods_score']; ?>R</span>
            </div>
            ...
            <div class="des_join">
            	<div class="j_nums">
                    ...
                    <input type="button" value="" class="n_btn_1 add" />
                    <input type="button" value="" class="n_btn_2 reduce" />   
                </div>
                <span class="fl">
                    <a onclick="javascript:;" id="addcart">
                        <img src="__STATIC__/index/images/j_car.png" />
                    </a>
                </span>
            </div>            
        </div>    
        ...
        $(function(){
            layui.use(['layer'],function(){
                ...
                function changeNumber(type,_this){
                    ...
                    if(type==1){  //判断type==1 走加号按钮  否则走减号按钮
                        _this.next().prop('disabled',false) 
                        //加号
                        if(buy_number>=goods_num){   
                            _input.val(goods_num);     //判断值大于等于库存 大于则改变值为库存
                            _this.prop('disabled',true);     //然后让加号按钮失效
                        }else{
                            buy_number+=1;          //否则加1 值为加以后的内容
                        ...
                        //减号
                        if(buy_number<=1){      
                            _input.val(1);      //判断值小于等于1 小于则改变值为1
                            _this.prop('disabled',true); //然后让减号按钮失效
                        }else{
                            buy_number-=1;      //否则加减1 值为减1后的内容
                            _input.val(buy_number)
                        }
                    }
                }
