...
<div class="i_bg bg_color">
    	...
    	<div class="banner">    	
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    <li><img src="__ROOT__/goods_img/20181205/cdbfe1ae9c060549556b024fbf561ceb.jpg" width="740" height="401" /></li>
                    <li><img src="__ROOT__/goods_img/20181129/2b89888593cdcf781fdeb2005a3c9c01.jpg" width="740" height="401" /></li> 
                    <li><img src="__ROOT__/goods_img/20181129/7c40b700555c78d730f6c3fcae8196f2.jpg" width="740" height="401" /></li> 
                </ul>	
        ...
        <div class="content">
            ...
            <div class="fresh_mid">
                <ul>
                    ...
                    <li>
                        <div class="name"><a href="<?php echo url('product/productdetail'); ?>?goods_id=<?php echo $v['goods_id']; ?>"><?php echo $v['goods_name']; ?></a></div>
                        <div class="price">
                            <font>￥<span><?php echo $v['self_price']; ?></span></font> &nbsp; <?php echo $v['goods_score']; ?>R
                        </div>
                        <div class="img"><a href="<?php echo url('product/productdetail'); ?>?goods_id=<?php echo $v['goods_id']; ?>"><img src="__ROOT__/goods_img/<?php echo $v['goods_img']; ?>" width="185" height="155" /></a></div>
                    </li>  
                    <?php endforeach; endif; else: echo "" ;endif; ?>                                                                   
                </ul>
            </div>
    ...
    <!--End 进口 生鲜 End-->
    <a href="javascript:;" id="more"><div style="text-align: center"><font size="4px" color="red">加载更多</font></div></a>
    <!--Begin 猜你喜欢 Begin-->
    <div class="i_t mar_10">
    ...
    <script>
        $(function(){
            $("#more").click(function(){
                ...
                var floor_num=_this.prev('div').attr('floor_num')
                ...
                $.post(
                    ...
                    function(result){
                        if(result!=""){
                            ...
                            _this.hide()
                            _this.after('<a href="javascript:;" id="more"><div style="text-align: center"><font size="4px" color="red">亲;已经到底了</font></div></a>')
                        }
